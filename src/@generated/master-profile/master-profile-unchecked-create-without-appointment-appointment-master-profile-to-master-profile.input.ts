...
@InputType()
export class MasterProfileUncheckedCreateWithoutAppointment_Appointment_masterProfileToMasterProfileInput {
    ...
    @Field(() => MasterScheduleUncheckedCreateNestedManyWithoutMasterProfileInput, {nullable:true})
