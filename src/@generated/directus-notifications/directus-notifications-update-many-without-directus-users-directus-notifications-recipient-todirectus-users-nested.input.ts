...
@InputType()
export class directus_notificationsUpdateManyWithoutDirectus_users_directus_notifications_recipientTodirectus_usersNestedInput {
  @Field(
    () => [
  ...
  @Field(
    () => [
      directus_notificationsCreateOrConnectWithoutDirectus_users_directus_notifications_recipientTodirectus_usersInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_notificationsUpsertWithWhereUniqueWithoutDirectus_users_directus_notifications_recipientTodirectus_usersInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () =>
      directus_notificationsCreateManyDirectus_users_directus_notifications_recipientTodirectus_usersInputEnvelope,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Type(() => directus_notificationsWhereUniqueInput)
  disconnect?: Array<
    Prisma.AtLeast<directus_notificationsWhereUniqueInput, 'id'>
  >;
  ...
  @Field(
    () => [
      directus_notificationsUpdateWithWhereUniqueWithoutDirectus_users_directus_notifications_recipientTodirectus_usersInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_notificationsUpdateManyWithWhereWithoutDirectus_users_directus_notifications_recipientTodirectus_usersInput,
    ],
    { nullable: true },
  )
  @Type(
