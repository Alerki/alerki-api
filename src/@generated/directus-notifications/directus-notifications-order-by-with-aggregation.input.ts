...
export class directus_notificationsOrderByWithAggregationInput {
  ...
  @Field(() => directus_notificationsCountOrderByAggregateInput, {
    nullable: true,
  })
  _count?: directus_notificationsCountOrderByAggregateInput;

  @Field(() => directus_notificationsAvgOrderByAggregateInput, {
    nullable: true,
  })
  _avg?: directus_notificationsAvgOrderByAggregateInput;

  @Field(() => directus_notificationsMaxOrderByAggregateInput, {
    nullable: true,
  })
  _max?: directus_notificationsMaxOrderByAggregateInput;

  @Field(() => directus_notificationsMinOrderByAggregateInput, {
    nullable: true,
  })
  _min?: directus_notificationsMinOrderByAggregateInput;

  @Field(() => directus_notificationsSumOrderByAggregateInput, {
    nullable: true,
  })
