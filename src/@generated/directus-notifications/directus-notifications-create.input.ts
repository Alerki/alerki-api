...
export class directus_notificationsCreateInput {
  ...
  @Field(
    () =>
      directus_usersCreateNestedOneWithoutDirectus_notifications_directus_notifications_recipientTodirectus_usersInput,
    { nullable: false },
  )
  ...
  @Field(
    () =>
      directus_usersCreateNestedOneWithoutDirectus_notifications_directus_notifications_senderTodirectus_usersInput,
    { nullable: true },
  )
