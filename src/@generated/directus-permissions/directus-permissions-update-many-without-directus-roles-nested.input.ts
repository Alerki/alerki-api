...
@InputType()
export class directus_permissionsUpdateManyWithoutDirectus_rolesNestedInput {
    ...
    @Field(() => [directus_permissionsUpsertWithWhereUniqueWithoutDirectus_rolesInput], {nullable:true})
    @Type(() => directus_permissionsUpsertWithWhereUniqueWithoutDirectus_rolesInput)
    ...
    @Field(() => [directus_permissionsWhereUniqueInput], {nullable:true})
    @Type(() => directus_permissionsWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<directus_permissionsWhereUniqueInput, 'id'>>;
    ...
    @Field(() => [directus_permissionsUpdateWithWhereUniqueWithoutDirectus_rolesInput], {nullable:true})
    @Type(() => directus_permissionsUpdateWithWhereUniqueWithoutDirectus_rolesInput)
    update?: Array<directus_permissionsUpdateWithWhereUniqueWithoutDirectus_rolesInput>;

    @Field(() => [directus_permissionsUpdateManyWithWhereWithoutDirectus_rolesInput], {nullable:true})
