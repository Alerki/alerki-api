...
export class directus_revisionsUpdateOneWithoutOther_directus_revisionsNestedInput {
    ...
    @Field(() => directus_revisionsUpsertWithoutOther_directus_revisionsInput, {nullable:true})
    ...
    @Field(() => directus_revisionsUpdateWithoutOther_directus_revisionsInput, {nullable:true})
