...
export class FindFirstdirectusExtensionsOrThrowArgs {
  ...
  @Field(() => [Directus_extensionsScalarFieldEnum], { nullable: true })
  distinct?: Array<keyof typeof Directus_extensionsScalarFieldEnum>;
}
