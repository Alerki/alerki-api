...
export class directus_foldersUpdateOneWithoutOther_directus_foldersNestedInput {
    ...
    @Field(() => directus_foldersUpsertWithoutOther_directus_foldersInput, {nullable:true})
    ...
    @Field(() => directus_foldersUpdateWithoutOther_directus_foldersInput, {nullable:true})
