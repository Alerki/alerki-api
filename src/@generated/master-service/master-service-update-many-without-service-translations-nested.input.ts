...
@InputType()
export class MasterServiceUpdateManyWithoutService_translationsNestedInput {
    ...
    @Field(() => [MasterServiceUpsertWithWhereUniqueWithoutService_translationsInput], {nullable:true})
    @Type(() => MasterServiceUpsertWithWhereUniqueWithoutService_translationsInput)
    ...
    @Field(() => [MasterServiceUpdateWithWhereUniqueWithoutService_translationsInput], {nullable:true})
    @Type(() => MasterServiceUpdateWithWhereUniqueWithoutService_translationsInput)
    update?: Array<MasterServiceUpdateWithWhereUniqueWithoutService_translationsInput>;

    @Field(() => [MasterServiceUpdateManyWithWhereWithoutService_translationsInput], {nullable:true})
