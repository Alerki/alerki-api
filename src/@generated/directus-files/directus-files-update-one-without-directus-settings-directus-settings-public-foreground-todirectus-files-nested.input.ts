...
export class directus_filesUpdateOneWithoutDirectus_settings_directus_settings_public_foregroundTodirectus_filesNestedInput {
    ...
    @Field(() => directus_filesUpsertWithoutDirectus_settings_directus_settings_public_foregroundTodirectus_filesInput, {nullable:true})
    @Type(() => directus_filesUpsertWithoutDirectus_settings_directus_settings_public_foregroundTodirectus_filesInput)
    ...
    @Field(() => directus_filesUpdateWithoutDirectus_settings_directus_settings_public_foregroundTodirectus_filesInput, {nullable:true})
