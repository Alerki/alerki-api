...
import { directus_filesUpsertWithWhereUniqueWithoutDirectus_users_directus_files_modified_byTodirectus_usersInput } from './directus-files-upsert-with-where-unique-without-directus-users-directus-files-modified-by-todirectus-users.input';
...
import { directus_filesUpdateWithWhereUniqueWithoutDirectus_users_directus_files_modified_byTodirectus_usersInput } from './directus-files-update-with-where-unique-without-directus-users-directus-files-modified-by-todirectus-users.input';
import { directus_filesUpdateManyWithWhereWithoutDirectus_users_directus_files_modified_byTodirectus_usersInput } from './directus-files-update-many-with-where-without-directus-users-directus-files-modified-by-todirectus-users.input';
import { directus_filesScalarWhereInput } from './directus-files-scalar-where.input';

@InputType()
export class directus_filesUncheckedUpdateManyWithoutDirectus_users_directus_files_modified_byTodirectus_usersNestedInput {
