...
import { directus_filesUpsertWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput } from './directus-files-upsert-without-directus-settings-directus-settings-project-logo-todirectus-files.input';
...
@InputType()
export class directus_filesUpdateOneWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesNestedInput {
    ...
    @Field(() => directus_filesUpsertWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput, {nullable:true})
    @Type(() => directus_filesUpsertWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput)
    upsert?: directus_filesUpsertWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput;
    ...
    @Field(() => directus_filesUpdateWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput, {nullable:true})
