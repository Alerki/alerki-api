...
export class directus_filesUpdateOneWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesNestedInput {
  ...
  @Field(
    () =>
      directus_filesCreateOrConnectWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () =>
      directus_filesUpsertWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput,
    { nullable: true },
  )
  @Type(
    () =>
