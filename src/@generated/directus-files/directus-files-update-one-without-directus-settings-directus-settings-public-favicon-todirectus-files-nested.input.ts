...
export class directus_filesUpdateOneWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesNestedInput {
    ...
    @Field(() => directus_filesCreateWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput, {nullable:true})
    @Type(() => directus_filesCreateWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput)
    create?: directus_filesCreateWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput;

    @Field(() => directus_filesCreateOrConnectWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput, {nullable:true})
    @Type(() => directus_filesCreateOrConnectWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput)
    ...
    @Field(() => directus_filesUpsertWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput, {nullable:true})
    @Type(() => directus_filesUpsertWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput)
    ...
    @Field(() => directus_filesUpdateWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput, {nullable:true})
    @Type(() => directus_filesUpdateWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput)
