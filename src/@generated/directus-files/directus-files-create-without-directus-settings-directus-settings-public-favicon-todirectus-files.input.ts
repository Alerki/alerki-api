...
import { directus_settingsCreateNestedManyWithoutDirectus_files_directus_settings_public_foregroundTodirectus_filesInput } from '../directus-settings/directus-settings-create-nested-many-without-directus-files-directus-settings-public-foreground-todirectus-files.input';

@InputType()
export class directus_filesCreateWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput {
  ...
  @Field(() => UserPictureCreateNestedManyWithoutDirectus_filesInput, {
    nullable: true,
  })
  UserPicture?: UserPictureCreateNestedManyWithoutDirectus_filesInput;

  @Field(() => directus_foldersCreateNestedOneWithoutDirectus_filesInput, {
    nullable: true,
  })
  ...
  @Field(
    () =>
      directus_usersCreateNestedOneWithoutDirectus_files_directus_files_modified_byTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_usersCreateNestedOneWithoutDirectus_files_directus_files_uploaded_byTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_settingsCreateNestedManyWithoutDirectus_files_directus_settings_project_logoTodirectus_filesInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_settingsCreateNestedManyWithoutDirectus_files_directus_settings_public_backgroundTodirectus_filesInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_settingsCreateNestedManyWithoutDirectus_files_directus_settings_public_foregroundTodirectus_filesInput,
    { nullable: true },
  )
  directus_settings_directus_settings_public_foregroundTodirectus_files?: directus_settingsCreateNestedManyWithoutDirectus_files_directus_settings_public_foregroundTodirectus_filesInput;
}
