...
import { directus_filesUpsertWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesInput } from './directus-files-upsert-without-directus-settings-directus-settings-public-background-todirectus-files.input';
...
@InputType()
export class directus_filesUpdateOneWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesNestedInput {
  @Field(
    () =>
      directus_filesCreateWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () =>
      directus_filesCreateOrConnectWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () =>
      directus_filesUpsertWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  upsert?: directus_filesUpsertWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesInput;
  ...
  @Field(
    () =>
      directus_filesUpdateWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesInput,
    { nullable: true },
  )
  @Type(
    () =>
