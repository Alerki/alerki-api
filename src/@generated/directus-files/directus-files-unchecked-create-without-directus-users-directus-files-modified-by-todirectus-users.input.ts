...
@InputType()
export class directus_filesUncheckedCreateWithoutDirectus_users_directus_files_modified_byTodirectus_usersInput {
    ...
    @Field(() => UserPictureUncheckedCreateNestedManyWithoutDirectus_filesInput, {nullable:true})
    UserPicture?: UserPictureUncheckedCreateNestedManyWithoutDirectus_filesInput;

    @Field(() => directus_settingsUncheckedCreateNestedManyWithoutDirectus_files_directus_settings_project_logoTodirectus_filesInput, {nullable:true})
    ...
    @Field(() => directus_settingsUncheckedCreateNestedManyWithoutDirectus_files_directus_settings_public_backgroundTodirectus_filesInput, {nullable:true})
    ...
    @Field(() => directus_settingsUncheckedCreateNestedManyWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesInput, {nullable:true})
    ...
    @Field(() => directus_settingsUncheckedCreateNestedManyWithoutDirectus_files_directus_settings_public_foregroundTodirectus_filesInput, {nullable:true})
