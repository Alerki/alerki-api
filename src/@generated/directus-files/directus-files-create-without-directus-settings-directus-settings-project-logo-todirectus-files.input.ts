...
@InputType()
export class directus_filesCreateWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput {
  ...
  @Field(
    () =>
      directus_settingsCreateNestedManyWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesInput,
    { nullable: true },
  )
