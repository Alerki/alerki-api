...
@InputType()
export class directus_filesUncheckedUpdateManyWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersNestedInput {
    ...
    @Field(() => [directus_filesUpsertWithWhereUniqueWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersInput], {nullable:true})
    @Type(() => directus_filesUpsertWithWhereUniqueWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersInput)
    ...
    @Field(() => [directus_filesUpdateWithWhereUniqueWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersInput], {nullable:true})
    @Type(() => directus_filesUpdateWithWhereUniqueWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersInput)
    update?: Array<directus_filesUpdateWithWhereUniqueWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersInput>;

    @Field(() => [directus_filesUpdateManyWithWhereWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersInput], {nullable:true})
    @Type(() => directus_filesUpdateManyWithWhereWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersInput)
