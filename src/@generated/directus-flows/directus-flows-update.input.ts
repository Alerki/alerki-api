...
import { directus_operationsUpdateManyWithoutDirectus_flowsNestedInput } from '../directus-operations/directus-operations-update-many-without-directus-flows-nested.input';
...
export class directus_flowsUpdateInput {
  ...
  @Field(() => directus_usersUpdateOneWithoutDirectus_flowsNestedInput, {
    nullable: true,
  })
  directus_users?: directus_usersUpdateOneWithoutDirectus_flowsNestedInput;

  @Field(() => directus_operationsUpdateManyWithoutDirectus_flowsNestedInput, {
    nullable: true,
  })
  directus_operations?: directus_operationsUpdateManyWithoutDirectus_flowsNestedInput;
}
