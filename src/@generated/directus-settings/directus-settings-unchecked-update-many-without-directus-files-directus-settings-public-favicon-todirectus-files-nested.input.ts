...
export class directus_settingsUncheckedUpdateManyWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesNestedInput {
  ...
  @Field(
    () => [
      directus_settingsUpsertWithWhereUniqueWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_settingsUpdateWithWhereUniqueWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_settingsUpdateManyWithWhereWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesInput,
    ],
    { nullable: true },
  )
  @Type(
