...
import { directus_filesUpdateOneWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesNestedInput } from '../directus-files/directus-files-update-one-without-directus-settings-directus-settings-project-logo-todirectus-files-nested.input';
...
@InputType()
export class directus_settingsUpdateInput {
  ...
  @Field(
    () =>
      directus_filesUpdateOneWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesNestedInput,
    { nullable: true },
  )
  directus_files_directus_settings_project_logoTodirectus_files?: directus_filesUpdateOneWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesNestedInput;

  @Field(
    () =>
      directus_filesUpdateOneWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesNestedInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_filesUpdateOneWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesNestedInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_filesUpdateOneWithoutDirectus_settings_directus_settings_public_foregroundTodirectus_filesNestedInput,
    { nullable: true },
  )
  ...
  @Field(() => directus_foldersUpdateOneWithoutDirectus_settingsNestedInput, {
    nullable: true,
  })
