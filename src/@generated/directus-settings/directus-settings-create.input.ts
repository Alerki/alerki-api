...
import { directus_filesCreateNestedOneWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput } from '../directus-files/directus-files-create-nested-one-without-directus-settings-directus-settings-project-logo-todirectus-files.input';
...
@InputType()
export class directus_settingsCreateInput {
    ...
    @Field(() => directus_filesCreateNestedOneWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput, {nullable:true})
    directus_files_directus_settings_project_logoTodirectus_files?: directus_filesCreateNestedOneWithoutDirectus_settings_directus_settings_project_logoTodirectus_filesInput;

    @Field(() => directus_filesCreateNestedOneWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesInput, {nullable:true})
    ...
    @Field(() => directus_filesCreateNestedOneWithoutDirectus_settings_directus_settings_public_faviconTodirectus_filesInput, {nullable:true})
    ...
    @Field(() => directus_filesCreateNestedOneWithoutDirectus_settings_directus_settings_public_foregroundTodirectus_filesInput, {nullable:true})
    ...
    @Field(() => directus_foldersCreateNestedOneWithoutDirectus_settingsInput, {nullable:true})
