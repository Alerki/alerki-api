...
@InputType()
export class directus_settingsUpdateManyWithoutDirectus_files_directus_settings_project_logoTodirectus_filesNestedInput {
  @Field(
    () => [
  ...
  @Field(
    () => [
      directus_settingsUpsertWithWhereUniqueWithoutDirectus_files_directus_settings_project_logoTodirectus_filesInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_settingsUpdateWithWhereUniqueWithoutDirectus_files_directus_settings_project_logoTodirectus_filesInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_settingsUpdateManyWithWhereWithoutDirectus_files_directus_settings_project_logoTodirectus_filesInput,
    ],
    { nullable: true },
  )
  @Type(
