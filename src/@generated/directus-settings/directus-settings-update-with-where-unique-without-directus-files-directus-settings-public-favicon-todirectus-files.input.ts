...
@InputType()
export class directus_settingsUpdateWithWhereUniqueWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesInput {
  ...
  @Field(
    () =>
      directus_settingsUpdateWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesInput,
    { nullable: false },
  )
  @Type(
    () =>
  ...
  data!: directus_settingsUpdateWithoutDirectus_files_directus_settings_public_faviconTodirectus_filesInput;
}
