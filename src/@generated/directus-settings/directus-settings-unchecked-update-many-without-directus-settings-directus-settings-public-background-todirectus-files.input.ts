...
@InputType()
export class directus_settingsUncheckedUpdateManyWithoutDirectus_settings_directus_settings_public_backgroundTodirectus_filesInput {
    ...
    @Field(() => NullableStringFieldUpdateOperationsInput, {nullable:true})
    public_foreground?: NullableStringFieldUpdateOperationsInput;
