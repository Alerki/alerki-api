...
export class directus_collectionsUpdateManyWithoutDirectus_collectionsNestedInput {
    ...
    @Field(() => [directus_collectionsUpsertWithWhereUniqueWithoutDirectus_collectionsInput], {nullable:true})
    @Type(() => directus_collectionsUpsertWithWhereUniqueWithoutDirectus_collectionsInput)
    ...
    set?: Array<Prisma.AtLeast<directus_collectionsWhereUniqueInput, 'collection'>>;

    @Field(() => [directus_collectionsWhereUniqueInput], {nullable:true})
    @Type(() => directus_collectionsWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<directus_collectionsWhereUniqueInput, 'collection'>>;

    @Field(() => [directus_collectionsWhereUniqueInput], {nullable:true})
    @Type(() => directus_collectionsWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<directus_collectionsWhereUniqueInput, 'collection'>>;

    @Field(() => [directus_collectionsWhereUniqueInput], {nullable:true})
    @Type(() => directus_collectionsWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<directus_collectionsWhereUniqueInput, 'collection'>>;

    @Field(() => [directus_collectionsUpdateWithWhereUniqueWithoutDirectus_collectionsInput], {nullable:true})
    @Type(() => directus_collectionsUpdateWithWhereUniqueWithoutDirectus_collectionsInput)
    update?: Array<directus_collectionsUpdateWithWhereUniqueWithoutDirectus_collectionsInput>;

    @Field(() => [directus_collectionsUpdateManyWithWhereWithoutDirectus_collectionsInput], {nullable:true})
    @Type(() => directus_collectionsUpdateManyWithWhereWithoutDirectus_collectionsInput)
