...
@InputType()
export class directus_collectionsUncheckedUpdateWithoutDirectus_collectionsInput {
  ...
  @Field(
    () =>
      directus_collectionsUncheckedUpdateManyWithoutDirectus_collectionsNestedInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_sharesUncheckedUpdateManyWithoutDirectus_collectionsNestedInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_versionsUncheckedUpdateManyWithoutDirectus_collectionsNestedInput,
    { nullable: true },
  )
