...
@InputType()
export class directus_presetsUpdateManyWithoutDirectus_rolesNestedInput {

    @Field(() => [directus_presetsCreateWithoutDirectus_rolesInput], {nullable:true})
    @Type(() => directus_presetsCreateWithoutDirectus_rolesInput)
    create?: Array<directus_presetsCreateWithoutDirectus_rolesInput>;

    @Field(() => [directus_presetsCreateOrConnectWithoutDirectus_rolesInput], {nullable:true})
    ...
    @Field(() => [directus_presetsUpsertWithWhereUniqueWithoutDirectus_rolesInput], {nullable:true})
    ...
    @Field(() => directus_presetsCreateManyDirectus_rolesInputEnvelope, {nullable:true})
    ...
    @Field(() => [directus_presetsUpdateWithWhereUniqueWithoutDirectus_rolesInput], {nullable:true})
    ...
    @Field(() => [directus_presetsUpdateManyWithWhereWithoutDirectus_rolesInput], {nullable:true})
