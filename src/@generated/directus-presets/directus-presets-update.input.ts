...
import { directus_usersUpdateOneWithoutDirectus_presetsNestedInput } from '../directus-users/directus-users-update-one-without-directus-presets-nested.input';

@InputType()
export class directus_presetsUpdateInput {
    ...
    @Field(() => directus_rolesUpdateOneWithoutDirectus_presetsNestedInput, {nullable:true})
    directus_roles?: directus_rolesUpdateOneWithoutDirectus_presetsNestedInput;

    @Field(() => directus_usersUpdateOneWithoutDirectus_presetsNestedInput, {nullable:true})
    directus_users?: directus_usersUpdateOneWithoutDirectus_presetsNestedInput;
}
