...
export class directus_sharesCreateInput {
  ...
  @Field(() => directus_sessionsCreateNestedManyWithoutDirectus_sharesInput, {
    nullable: true,
  })
  directus_sessions?: directus_sessionsCreateNestedManyWithoutDirectus_sharesInput;

  @Field(() => directus_collectionsCreateNestedOneWithoutDirectus_sharesInput, {
    nullable: false,
  })
  directus_collections!: directus_collectionsCreateNestedOneWithoutDirectus_sharesInput;

  @Field(() => directus_rolesCreateNestedOneWithoutDirectus_sharesInput, {
    nullable: true,
  })
  directus_roles?: directus_rolesCreateNestedOneWithoutDirectus_sharesInput;

  @Field(() => directus_usersCreateNestedOneWithoutDirectus_sharesInput, {
    nullable: true,
  })
