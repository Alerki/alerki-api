...
@InputType()
export class directus_sharesUncheckedCreateWithoutDirectus_collectionsInput {
    ...
    @Field(() => directus_sessionsUncheckedCreateNestedManyWithoutDirectus_sharesInput, {nullable:true})
