...
import { directus_sessionsUpdateManyWithoutDirectus_sharesNestedInput } from '../directus-sessions/directus-sessions-update-many-without-directus-shares-nested.input';
...
@InputType()
export class directus_sharesUpdateWithoutDirectus_collectionsInput {
