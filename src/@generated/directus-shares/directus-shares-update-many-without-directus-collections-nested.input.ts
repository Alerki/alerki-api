...
@InputType()
export class directus_sharesUpdateManyWithoutDirectus_collectionsNestedInput {
  ...
  @Field(
    () => [
      directus_sharesUpsertWithWhereUniqueWithoutDirectus_collectionsInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_sharesUpdateWithWhereUniqueWithoutDirectus_collectionsInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [directus_sharesUpdateManyWithWhereWithoutDirectus_collectionsInput],
    { nullable: true },
  )
  @Type(
    () => directus_sharesUpdateManyWithWhereWithoutDirectus_collectionsInput,
