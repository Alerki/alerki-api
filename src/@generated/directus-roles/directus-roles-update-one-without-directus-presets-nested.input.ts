...
export class directus_rolesUpdateOneWithoutDirectus_presetsNestedInput {
    ...
    @Field(() => directus_rolesCreateWithoutDirectus_presetsInput, {nullable:true})
    @Type(() => directus_rolesCreateWithoutDirectus_presetsInput)
    create?: directus_rolesCreateWithoutDirectus_presetsInput;

    @Field(() => directus_rolesCreateOrConnectWithoutDirectus_presetsInput, {nullable:true})
    ...
    @Field(() => directus_rolesUpsertWithoutDirectus_presetsInput, {nullable:true})
    ...
    @Field(() => directus_rolesUpdateWithoutDirectus_presetsInput, {nullable:true})
