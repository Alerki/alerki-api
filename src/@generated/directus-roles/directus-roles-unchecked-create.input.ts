...
import { directus_usersUncheckedCreateNestedManyWithoutDirectus_rolesInput } from '../directus-users/directus-users-unchecked-create-nested-many-without-directus-roles.input';

@InputType()
export class directus_rolesUncheckedCreateInput {
    ...
    @Field(() => directus_permissionsUncheckedCreateNestedManyWithoutDirectus_rolesInput, {nullable:true})
    directus_permissions?: directus_permissionsUncheckedCreateNestedManyWithoutDirectus_rolesInput;

    @Field(() => directus_presetsUncheckedCreateNestedManyWithoutDirectus_rolesInput, {nullable:true})
    directus_presets?: directus_presetsUncheckedCreateNestedManyWithoutDirectus_rolesInput;

    @Field(() => directus_sharesUncheckedCreateNestedManyWithoutDirectus_rolesInput, {nullable:true})
    directus_shares?: directus_sharesUncheckedCreateNestedManyWithoutDirectus_rolesInput;

    @Field(() => directus_usersUncheckedCreateNestedManyWithoutDirectus_rolesInput, {nullable:true})
    directus_users?: directus_usersUncheckedCreateNestedManyWithoutDirectus_rolesInput;
}
