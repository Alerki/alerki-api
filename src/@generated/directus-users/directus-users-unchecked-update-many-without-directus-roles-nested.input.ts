...
@InputType()
export class directus_usersUncheckedUpdateManyWithoutDirectus_rolesNestedInput {
    ...
    @Field(() => [directus_usersUpsertWithWhereUniqueWithoutDirectus_rolesInput], {nullable:true})
    ...
    set?: Array<Prisma.AtLeast<directus_usersWhereUniqueInput, 'id' | 'email' | 'token' | 'external_identifier'>>;

    @Field(() => [directus_usersWhereUniqueInput], {nullable:true})
    @Type(() => directus_usersWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<directus_usersWhereUniqueInput, 'id' | 'email' | 'token' | 'external_identifier'>>;

    @Field(() => [directus_usersWhereUniqueInput], {nullable:true})
    @Type(() => directus_usersWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<directus_usersWhereUniqueInput, 'id' | 'email' | 'token' | 'external_identifier'>>;

    @Field(() => [directus_usersWhereUniqueInput], {nullable:true})
    @Type(() => directus_usersWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<directus_usersWhereUniqueInput, 'id' | 'email' | 'token' | 'external_identifier'>>;

    @Field(() => [directus_usersUpdateWithWhereUniqueWithoutDirectus_rolesInput], {nullable:true})
    ...
    @Field(() => [directus_usersUpdateManyWithWhereWithoutDirectus_rolesInput], {nullable:true})
