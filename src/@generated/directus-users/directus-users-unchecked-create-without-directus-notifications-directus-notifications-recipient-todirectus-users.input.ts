...
import { directus_filesUncheckedCreateNestedManyWithoutDirectus_users_directus_files_modified_byTodirectus_usersInput } from '../directus-files/directus-files-unchecked-create-nested-many-without-directus-users-directus-files-modified-by-todirectus-users.input';
...
@InputType()
export class directus_usersUncheckedCreateWithoutDirectus_notifications_directus_notifications_recipientTodirectus_usersInput {
  ...
  @Field(
    () =>
      directus_versionsUncheckedCreateNestedManyWithoutDirectus_users_directus_versions_user_createdTodirectus_usersInput,
    { nullable: true },
  )
