...
import { NotificationTypeCreateNestedManyWithoutDirectus_users_NotificationType_user_updatedTodirectus_usersInput } from '../notification-type/notification-type-create-nested-many-without-directus-users-notification-type-user-updated-todirectus-users.input';
...
@InputType()
export class directus_usersCreateWithoutService_Service_user_createdTodirectus_usersInput {
  ...
  @Field(
    () =>
      CurrencyCreateNestedManyWithoutDirectus_users_Currency_user_createdTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      CurrencyCreateNestedManyWithoutDirectus_users_Currency_user_updatedTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      NotificationTypeCreateNestedManyWithoutDirectus_users_NotificationType_user_createdTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      NotificationTypeCreateNestedManyWithoutDirectus_users_NotificationType_user_updatedTodirectus_usersInput,
    { nullable: true },
  )
  NotificationType_NotificationType_user_updatedTodirectus_users?: NotificationTypeCreateNestedManyWithoutDirectus_users_NotificationType_user_updatedTodirectus_usersInput;

  @Field(
    () =>
      ServiceCreateNestedManyWithoutDirectus_users_Service_user_updatedTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(() => directus_dashboardsCreateNestedManyWithoutDirectus_usersInput, {
    nullable: true,
  })
  ...
  @Field(
    () =>
      directus_filesCreateNestedManyWithoutDirectus_users_directus_files_modified_byTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_filesCreateNestedManyWithoutDirectus_users_directus_files_uploaded_byTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(() => directus_flowsCreateNestedManyWithoutDirectus_usersInput, {
    nullable: true,
  })
  ...
  @Field(
    () =>
      directus_notificationsCreateNestedManyWithoutDirectus_users_directus_notifications_recipientTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_notificationsCreateNestedManyWithoutDirectus_users_directus_notifications_senderTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(() => directus_operationsCreateNestedManyWithoutDirectus_usersInput, {
    nullable: true,
  })
  directus_operations?: directus_operationsCreateNestedManyWithoutDirectus_usersInput;

  @Field(() => directus_panelsCreateNestedManyWithoutDirectus_usersInput, {
    nullable: true,
  })
  directus_panels?: directus_panelsCreateNestedManyWithoutDirectus_usersInput;

  @Field(() => directus_presetsCreateNestedManyWithoutDirectus_usersInput, {
    nullable: true,
  })
  directus_presets?: directus_presetsCreateNestedManyWithoutDirectus_usersInput;

  @Field(() => directus_sessionsCreateNestedManyWithoutDirectus_usersInput, {
    nullable: true,
  })
  directus_sessions?: directus_sessionsCreateNestedManyWithoutDirectus_usersInput;

  @Field(() => directus_sharesCreateNestedManyWithoutDirectus_usersInput, {
    nullable: true,
  })
  directus_shares?: directus_sharesCreateNestedManyWithoutDirectus_usersInput;

  @Field(() => directus_rolesCreateNestedOneWithoutDirectus_usersInput, {
    nullable: true,
  })
  ...
  @Field(
    () =>
      directus_versionsCreateNestedManyWithoutDirectus_users_directus_versions_user_createdTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(
    () =>
      directus_versionsCreateNestedManyWithoutDirectus_users_directus_versions_user_updatedTodirectus_usersInput,
    { nullable: true },
  )
