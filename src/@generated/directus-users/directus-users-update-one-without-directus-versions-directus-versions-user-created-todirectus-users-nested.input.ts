...
export class directus_usersUpdateOneWithoutDirectus_versions_directus_versions_user_createdTodirectus_usersNestedInput {
    ...
    @Field(() => directus_usersCreateWithoutDirectus_versions_directus_versions_user_createdTodirectus_usersInput, {nullable:true})
    ...
    @Field(() => directus_usersCreateOrConnectWithoutDirectus_versions_directus_versions_user_createdTodirectus_usersInput, {nullable:true})
    @Type(() => directus_usersCreateOrConnectWithoutDirectus_versions_directus_versions_user_createdTodirectus_usersInput)
    ...
    @Field(() => directus_usersUpsertWithoutDirectus_versions_directus_versions_user_createdTodirectus_usersInput, {nullable:true})
    @Type(() => directus_usersUpsertWithoutDirectus_versions_directus_versions_user_createdTodirectus_usersInput)
    ...
    @Field(() => directus_usersUpdateWithoutDirectus_versions_directus_versions_user_createdTodirectus_usersInput, {nullable:true})
