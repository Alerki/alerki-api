...
@InputType()
export class directus_usersCreateWithoutCurrency_Currency_user_updatedTodirectus_usersInput {
  ...
  @Field(
    () =>
      ServiceCreateNestedManyWithoutDirectus_users_Service_user_createdTodirectus_usersInput,
    { nullable: true },
  )
