...
import { ServiceUpdateManyWithoutDirectus_users_Service_user_updatedTodirectus_usersNestedInput } from '../service/service-update-many-without-directus-users-service-user-updated-todirectus-users-nested.input';
...
@InputType()
export class directus_usersUpdateWithoutDirectus_notifications_directus_notifications_recipientTodirectus_usersInput {
    ...
    @Field(() => directus_flowsUpdateManyWithoutDirectus_usersNestedInput, {nullable:true})
