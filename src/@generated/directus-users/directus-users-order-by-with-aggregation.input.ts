...
import { directus_usersCountOrderByAggregateInput } from './directus-users-count-order-by-aggregate.input';
import { directus_usersMaxOrderByAggregateInput } from './directus-users-max-order-by-aggregate.input';
import { directus_usersMinOrderByAggregateInput } from './directus-users-min-order-by-aggregate.input';
...
export class directus_usersOrderByWithAggregationInput {
  ...
  @Field(() => directus_usersCountOrderByAggregateInput, { nullable: true })
  _count?: directus_usersCountOrderByAggregateInput;

  @Field(() => directus_usersMaxOrderByAggregateInput, { nullable: true })
  _max?: directus_usersMaxOrderByAggregateInput;

  @Field(() => directus_usersMinOrderByAggregateInput, { nullable: true })
  _min?: directus_usersMinOrderByAggregateInput;
}
