...
import { directus_usersUpsertWithoutService_Service_user_updatedTodirectus_usersInput } from './directus-users-upsert-without-service-service-user-updated-todirectus-users.input';
...
@InputType()
export class directus_usersUpdateOneWithoutService_Service_user_updatedTodirectus_usersNestedInput {

    @Field(() => directus_usersCreateWithoutService_Service_user_updatedTodirectus_usersInput, {nullable:true})
    ...
    @Field(() => directus_usersCreateOrConnectWithoutService_Service_user_updatedTodirectus_usersInput, {nullable:true})
    @Type(() => directus_usersCreateOrConnectWithoutService_Service_user_updatedTodirectus_usersInput)
    connectOrCreate?: directus_usersCreateOrConnectWithoutService_Service_user_updatedTodirectus_usersInput;

    @Field(() => directus_usersUpsertWithoutService_Service_user_updatedTodirectus_usersInput, {nullable:true})
    @Type(() => directus_usersUpsertWithoutService_Service_user_updatedTodirectus_usersInput)
    upsert?: directus_usersUpsertWithoutService_Service_user_updatedTodirectus_usersInput;
    ...
    @Field(() => directus_usersUpdateWithoutService_Service_user_updatedTodirectus_usersInput, {nullable:true})
