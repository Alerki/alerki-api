...
export class directus_usersUpdateOneWithoutService_Service_user_updatedTodirectus_usersNestedInput {
  ...
  @Field(
    () =>
      directus_usersUpsertWithoutService_Service_user_updatedTodirectus_usersInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () =>
      directus_usersUpdateWithoutService_Service_user_updatedTodirectus_usersInput,
    { nullable: true },
  )
  @Type(
    () =>
