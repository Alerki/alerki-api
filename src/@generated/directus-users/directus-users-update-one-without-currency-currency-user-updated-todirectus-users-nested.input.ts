...
export class directus_usersUpdateOneWithoutCurrency_Currency_user_updatedTodirectus_usersNestedInput {
  ...
  @Field(
    () =>
      directus_usersCreateOrConnectWithoutCurrency_Currency_user_updatedTodirectus_usersInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () =>
      directus_usersUpsertWithoutCurrency_Currency_user_updatedTodirectus_usersInput,
    { nullable: true },
  )
  @Type(
    () =>
