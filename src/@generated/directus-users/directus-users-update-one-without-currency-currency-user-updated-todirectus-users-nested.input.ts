...
import { directus_usersUpsertWithoutCurrency_Currency_user_updatedTodirectus_usersInput } from './directus-users-upsert-without-currency-currency-user-updated-todirectus-users.input';
...
@InputType()
export class directus_usersUpdateOneWithoutCurrency_Currency_user_updatedTodirectus_usersNestedInput {
    ...
    @Field(() => directus_usersUpsertWithoutCurrency_Currency_user_updatedTodirectus_usersInput, {nullable:true})
    @Type(() => directus_usersUpsertWithoutCurrency_Currency_user_updatedTodirectus_usersInput)
    upsert?: directus_usersUpsertWithoutCurrency_Currency_user_updatedTodirectus_usersInput;
    ...
    @Field(() => directus_usersUpdateWithoutCurrency_Currency_user_updatedTodirectus_usersInput, {nullable:true})
    @Type(() => directus_usersUpdateWithoutCurrency_Currency_user_updatedTodirectus_usersInput)
