...
@InputType()
export class directus_versionsUpdateManyWithoutDirectus_users_directus_versions_user_updatedTodirectus_usersNestedInput {
  @Field(
    () => [
  ...
  @Field(
    () => [
      directus_versionsUpsertWithWhereUniqueWithoutDirectus_users_directus_versions_user_updatedTodirectus_usersInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_versionsUpdateWithWhereUniqueWithoutDirectus_users_directus_versions_user_updatedTodirectus_usersInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      directus_versionsUpdateManyWithWhereWithoutDirectus_users_directus_versions_user_updatedTodirectus_usersInput,
    ],
    { nullable: true },
  )
  @Type(
