...
import { directus_usersUpdateOneWithoutDirectus_versions_directus_versions_user_updatedTodirectus_usersNestedInput } from '../directus-users/directus-users-update-one-without-directus-versions-directus-versions-user-updated-todirectus-users-nested.input';

@InputType()
export class directus_versionsUpdateWithoutDirectus_users_directus_versions_user_createdTodirectus_usersInput {
