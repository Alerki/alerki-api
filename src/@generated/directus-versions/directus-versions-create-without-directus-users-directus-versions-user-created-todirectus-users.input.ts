...
@InputType()
export class directus_versionsCreateWithoutDirectus_users_directus_versions_user_createdTodirectus_usersInput {
  ...
  @Field(
    () => directus_collectionsCreateNestedOneWithoutDirectus_versionsInput,
    { nullable: false },
  )
