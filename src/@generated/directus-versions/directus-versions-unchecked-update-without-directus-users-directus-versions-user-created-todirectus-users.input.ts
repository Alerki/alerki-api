...
@InputType()
export class directus_versionsUncheckedUpdateWithoutDirectus_users_directus_versions_user_createdTodirectus_usersInput {
  ...
  @Field(
    () =>
      directus_revisionsUncheckedUpdateManyWithoutDirectus_versionsNestedInput,
    { nullable: true },
  )
