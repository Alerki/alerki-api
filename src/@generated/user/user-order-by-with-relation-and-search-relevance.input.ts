...
import { UserSenderOnNotificationOrderByRelationAggregateInput } from '../user-sender-on-notification/user-sender-on-notification-order-by-relation-aggregate.input';
...
export class UserOrderByWithRelationAndSearchRelevanceInput {
    ...
    @Field(() => UserSenderOnNotificationOrderByRelationAggregateInput, {nullable:true})
    UserSenderOnNotification_UserSenderOnNotification_notificationToUser?: UserSenderOnNotificationOrderByRelationAggregateInput;

    @Field(() => UserSenderOnNotificationOrderByRelationAggregateInput, {nullable:true})
    UserSenderOnNotification_UserSenderOnNotification_userToUser?: UserSenderOnNotificationOrderByRelationAggregateInput;
