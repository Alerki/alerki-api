...
@InputType()
export class UserUpdateWithoutUserSenderOnNotification_UserSenderOnNotification_notificationToUserInput {
  ...
  @Field(
    () =>
      UserSenderOnNotificationUpdateManyWithoutUser_UserSenderOnNotification_userToUserNestedInput,
    { nullable: true },
  )
