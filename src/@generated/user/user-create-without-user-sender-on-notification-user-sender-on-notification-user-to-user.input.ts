...
@InputType()
export class UserCreateWithoutUserSenderOnNotification_UserSenderOnNotification_userToUserInput {
  ...
  @Field(
    () =>
      UserSenderOnNotificationCreateNestedManyWithoutUser_UserSenderOnNotification_notificationToUserInput,
    { nullable: true },
  )
