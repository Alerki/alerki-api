...
@InputType()
export class UserUpdateManyWithoutClientProfileNestedInput {
  ...
  @Field(() => [UserUpsertWithWhereUniqueWithoutClientProfileInput], {
    nullable: true,
  })
