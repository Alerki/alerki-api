...
@InputType()
export class UserUncheckedCreateWithoutUserSenderOnNotification_UserSenderOnNotification_userToUserInput {
  ...
  @Field(
    () =>
      UserSenderOnNotificationUncheckedCreateNestedManyWithoutUser_UserSenderOnNotification_notificationToUserInput,
    { nullable: true },
  )
