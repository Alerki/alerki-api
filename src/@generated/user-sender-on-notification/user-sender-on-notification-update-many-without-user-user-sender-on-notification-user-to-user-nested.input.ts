...
@InputType()
export class UserSenderOnNotificationUpdateManyWithoutUser_UserSenderOnNotification_userToUserNestedInput {
  @Field(
    () => [
  ...
  @Field(
    () => [
      UserSenderOnNotificationUpsertWithWhereUniqueWithoutUser_UserSenderOnNotification_userToUserInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      UserSenderOnNotificationUpdateWithWhereUniqueWithoutUser_UserSenderOnNotification_userToUserInput,
    ],
    { nullable: true },
  )
  @Type(
  ...
  @Field(
    () => [
      UserSenderOnNotificationUpdateManyWithWhereWithoutUser_UserSenderOnNotification_userToUserInput,
    ],
    { nullable: true },
  )
  @Type(
