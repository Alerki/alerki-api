...
import { directus_operationsUpdateOneWithoutDirectus_operations_directus_operations_rejectTodirectus_operationsNestedInput } from './directus-operations-update-one-without-directus-operations-directus-operations-reject-todirectus-operations-nested.input';
...
@InputType()
export class directus_operationsUpdateWithoutOther_directus_operations_directus_operations_resolveTodirectus_operationsInput {
