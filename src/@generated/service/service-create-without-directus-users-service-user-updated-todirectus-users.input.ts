...
@InputType()
export class ServiceCreateWithoutDirectus_users_Service_user_updatedTodirectus_usersInput {
  ...
  @Field(
    () =>
      directus_usersCreateNestedOneWithoutService_Service_user_createdTodirectus_usersInput,
    { nullable: true },
  )
  ...
  @Field(() => Service_translationsCreateNestedManyWithoutServiceInput, {
    nullable: true,
  })
