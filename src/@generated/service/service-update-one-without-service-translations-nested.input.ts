...
export class ServiceUpdateOneWithoutService_translationsNestedInput {
    ...
    @Field(() => ServiceCreateWithoutService_translationsInput, {nullable:true})
    @Type(() => ServiceCreateWithoutService_translationsInput)
    create?: ServiceCreateWithoutService_translationsInput;

    @Field(() => ServiceCreateOrConnectWithoutService_translationsInput, {nullable:true})
    ...
    @Field(() => ServiceUpsertWithoutService_translationsInput, {nullable:true})
    ...
    @Field(() => ServiceUpdateWithoutService_translationsInput, {nullable:true})
