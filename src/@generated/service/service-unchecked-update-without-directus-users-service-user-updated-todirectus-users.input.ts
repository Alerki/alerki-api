...
@InputType()
export class ServiceUncheckedUpdateWithoutDirectus_users_Service_user_updatedTodirectus_usersInput {
  ...
  @Field(
    () => Service_translationsUncheckedUpdateManyWithoutServiceNestedInput,
    { nullable: true },
  )
