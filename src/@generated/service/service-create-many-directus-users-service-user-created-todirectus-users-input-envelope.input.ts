...
export class ServiceCreateManyDirectus_users_Service_user_createdTodirectus_usersInputEnvelope {
    ...
    @Field(() => [ServiceCreateManyDirectus_users_Service_user_createdTodirectus_usersInput], {nullable:false})
    @Type(() => ServiceCreateManyDirectus_users_Service_user_createdTodirectus_usersInput)
