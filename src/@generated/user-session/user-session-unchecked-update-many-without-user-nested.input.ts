...
@InputType()
export class User_SessionUncheckedUpdateManyWithoutUserNestedInput {
  ...
  @Field(() => [User_SessionUpsertWithWhereUniqueWithoutUserInput], {
    nullable: true,
  })
