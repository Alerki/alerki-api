...
@InputType()
export class User_SessionUncheckedUpdateManyWithoutSessionNestedInput {
    ...
    @Field(() => [User_SessionUpsertWithWhereUniqueWithoutSessionInput], {nullable:true})
    ...
    @Field(() => [User_SessionUpdateWithWhereUniqueWithoutSessionInput], {nullable:true})
    ...
    @Field(() => [User_SessionUpdateManyWithWhereWithoutSessionInput], {nullable:true})
