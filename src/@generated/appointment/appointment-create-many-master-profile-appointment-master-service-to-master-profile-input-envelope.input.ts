...
export class AppointmentCreateManyMasterProfile_Appointment_masterServiceToMasterProfileInputEnvelope {
    ...
    @Field(() => [AppointmentCreateManyMasterProfile_Appointment_masterServiceToMasterProfileInput], {nullable:false})
    @Type(() => AppointmentCreateManyMasterProfile_Appointment_masterServiceToMasterProfileInput)
