...
@InputType()
export class NotificationTypeUpdateWithoutDirectus_users_NotificationType_user_createdTodirectus_usersInput {
    ...
    @Field(() => directus_usersUpdateOneWithoutNotificationType_NotificationType_user_updatedTodirectus_usersNestedInput, {nullable:true})
