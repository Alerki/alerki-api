...
export class NotificationTypeCreateManyDirectus_users_NotificationType_user_updatedTodirectus_usersInputEnvelope {
    ...
    @Field(() => [NotificationTypeCreateManyDirectus_users_NotificationType_user_updatedTodirectus_usersInput], {nullable:false})
    @Type(() => NotificationTypeCreateManyDirectus_users_NotificationType_user_updatedTodirectus_usersInput)
